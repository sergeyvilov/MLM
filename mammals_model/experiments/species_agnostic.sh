...
#
#sbatch --array=0-0%1 species_agnostic.sh
#################################################################
...
test_name=species_agnostic_5000
...
--save_at 2:11:3 --validate_every 1  --species_agnostic \
--train_splits 4 --tot_epochs 11 --n_layers 4 --batch_size 128 --weight_decay 0 --seq_len 5000 --d_model 128"
