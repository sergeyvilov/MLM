...
#DNA BERT inference
#
#sbatch --array=0-36%10 dna_bert_eval.sh
#################################################################
...
output_dir="/s/project/mll/sergey/effect_prediction/MLM/motif_predictions/split_75_25/dnabert/$model/"

test_dataset='/s/project/mll/sergey/effect_prediction/MLM/motif_predictions/split_75_25/test.csv'
