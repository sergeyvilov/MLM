...
def model_train(model, optimizer, dataloader, device, silent=False):
    ...
    for itr_idx, ((masked_sequence, species_label), targets_masked, targets, _, _) in enumerate(dataloader):
...
def model_eval(model, optimizer, dataloader, device, get_embeddings = False, get_motif_acc=False, selected_motifs = None, silent=False):
    ...
    with torch.no_grad():
        ...
        for itr_idx, ((masked_sequence, species_label), targets_masked, targets, motif_mask, seq) in enumerate(dataloader):
